    ...
    return poolIndizes
      .map((poolId, idx) => {
        ...
        const poolEmissionAmount = chainId
          ? CurrencyAmount.fromRawAmount(tTOKEN[chainId], poolEmissionPerSecond || 0)
          : undefined
        ...
        const rawInfo: MinichefRawPoolInfo = {
          ...
          pendingAmount: chainId
            ? CurrencyAmount.fromRawAmount(tTOKEN[chainId], JSBI.BigInt(pendingResult?.pending?.toString() || 0))
            : undefined,

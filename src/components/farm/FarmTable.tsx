...
const PoolRow = styled(Link)`
  ...
  font-size: 1.1rem;
  //border: 1px solid rgba(154, 87, 0, 0.7);
  //box-shadow: 0 0 5px rgba(154, 87, 0, 0.05), 0 0 7px rgba(154, 87, 0, 0.05);
  :hover,
  :focus {
      ...
      <AutoRow gap="0%" justify={'space-between'}>
        ...
        <TVL>
          {tvl
            ...
            : `${totalLPStaked?.toSignificant(4, { groupSeparator: ',' }) ?? '-'} BRTR-LP`}
        </TVL>
        <RowColumn>
          <Emission>
            <EmissionText>

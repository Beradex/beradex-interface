...
const Card = styled(Box)<{ width?: string; padding?: string; border?: string; borderRadius?: string }>`
  ...
  box-shadow: 0 0 5px rgba(45, 26, 0, 0.1), 0 0 7px rgba(45, 26, 0, 0.1);
`
export default Card
...
export const LightGreyCard = styled(Card)`
  border: 1px solid rgba(161, 13, 141, 0);
  box-shadow: 0 0 5px rgba(234, 39, 208, 0), 0 0 7px rgba(234, 39, 208, 0);
  background-color: ${({ theme }) => theme.darkTransparent};
`
...
export const PinkCard = styled(Card)`
  background-color: rgba(234, 39, 208, 0.03);
